...
const MagicBento = (props: BentoProps & { cards?: { title: string; content: React.ReactNode }[] }) => {
  const {
    textAutoHide = true,
    enableStars = true,
  ...
  return (
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div
          className="flex flex-row flex-wrap gap-4 justify-center items-stretch w-[98vw] max-w-[1800px] mx-auto overflow-x-auto"
          style={{
            alignItems: 'stretch',
