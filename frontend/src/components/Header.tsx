  ...
  const UserNav = () => {
    ...
    return (
      <DropdownMenu>
        ...
        <DropdownMenuContent
          className={`w-56 ${isAuthenticated ? 'bg-primary text-primary-foreground' : 'bg-white'}`}
          align="end"
          forceMount
        >
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="pt-4 border-t border-border">
                {isAuthenticated && user ? (
                  <div className="flex items-center justify-between ">
                    <div className="flex items-center space-x-3 bg-primary/90 text-primary-foreground p-2 rounded-lg">
                      <Avatar className="h-10 w-10">
                        <AvatarFallback>{user.email.charAt(0).toUpperCase()}</AvatarFallback>
                      </Avatar>
                      <div>
                        <p className="text-sm font-medium leading-none capitalize text-blue-500">{user.role}</p>
